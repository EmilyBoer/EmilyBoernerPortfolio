...
$(document).ready( function() {
  ...
  $('#skill-group-container-four, #skill-group-container-three, #skill-group-container-two, #skill-group-container').hover( function() {
    $(this).find('.skill-group').addClass("fade-in-title-skills")
    $(this).find('.button-group').addClass("fade-in-button")
    $(this).find('.inner-image').addClass("hover-fade");
  }, function() {
    $(this).find('.skill-group').removeClass("fade-in-title-skills")
    $(this).find('.button-group').removeClass("fade-in-button")
    $(this).find('.inner-image').removeClass("hover-fade");
    console.log(this);
  });
